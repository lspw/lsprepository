	...
	$(function(){
		...
		$("#searchBtn").click(function (){
			...
			$("#searchText").keyup(function (){
				...
				//发送请求
				$.ajax({
					url:'workbench/clue/queryActivityConvertByNameClueId',
					data:{
		...
		$("#saveConvertClueBtn").click(function(){
			...
			//发送请求
			$.ajax({
				url:'workbench/clue/convertClue',
				data:{
					clueId:clueId,
					money:money,
					name:name,
...
<body>
					...
					<div class="btn-group" style="position: relative; top: 18%; left: 8px;">
						<form class="form-inline" role="form">
						  <div class="form-group has-feedback">
						    ...
						    <input type="text" class="form-control" id="searchText" style="width: 300px;" placeholder="请输入市场活动名称，支持模糊查询">
	...
	<div id="create-transaction2" style="position: relative; left: 40px; top: 20px; width: 80%; background-color: #F7F7F7; display: none;" >
		...
		<form>
		  ...
		  <div class="form-group" style="width: 400px;position: relative; left: 20px;">
			  <label for="activityName">市场活动源&nbsp;&nbsp;<a href="javascript:void(0);" id="searchBtn" style="text-decoration: none;"><span class="glyphicon glyphicon-search"></span></a></label>
			  <input type="hidden" id="activityIds">
